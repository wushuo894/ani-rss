...
native-image --static --libc=musl -march=compatibility -cp ./ani-rss-jar-with-dependencies.jar ani.rss.Main -o ani-rss-x86_64-linux-musl -H:+StaticExecutableWithDynamicLibC
